...
import { Star, Heart, Share2, ShoppingCart, Plus, Minus, Package } from "lucide-react"
    ...
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="grid grid-cols-2 gap-8 mb-8">
        ...
        <div className="space-y-4">
          <div className="aspect-square rounded-lg overflow-hidden bg-gradient-to-br from-emerald-100 to-emerald-200 flex items-center justify-center group">
            <div className="text-center space-y-3">
              <Package className="w-16 h-16 text-emerald-500 mx-auto" />
              <div className="space-y-1">
                <div className="text-sm font-medium text-emerald-700 line-clamp-2">{product.name}</div>
                <div className="text-xs text-emerald-600">Imagen principal aquí</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex space-x-2">
            {[0, 1, 2, 3].map((index) => (
              <button
                ...
                } bg-gradient-to-br from-emerald-100 to-emerald-200 flex items-center justify-center`}
              >
